...
public class InquiryVm {
	...
	@Wire
	private Div divInqData, divInqOrder, divInqPlanning;
	@Wire
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("arg") String arg,
		...
		if (arg.equals("inqdata")) {
			divInqData.setVisible(true);
		} else if (arg.equals("inqorder")) {
			divInqOrder.setVisible(true);
		} else if (arg.equals("inqplan")) {
			divInqPlanning.setVisible(true);
		}
		doRender();
	}
...
//					divBody.appendChild(lbl);
					...
					btn.addEventListener(Events.ON_CLICK, new EventListener<Event>() {
						...
						public void onEvent(Event event) throws Exception {
							...
							if (arg.equals("inqdata")) {
								Executions.createComponents("/view/inquiry/inquirydocument.zul", divContent, map);
							} else if (arg.equals("inqorder")) {
								Executions.createComponents("/view/inquiry/inquiryordercabang.zul", divContent, map);
							} else if (arg.equals("inqplan")) {
								Executions.createComponents("/view/inquiry/inquiryplan.zul", divContent, map);
							}
						}
					});
