...
public class CustdeliveryListVm {
	...
	private String isauto, isdlvcust;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			...
			@ExecutionArgParam("arg") String arg, @ExecutionArgParam("isDeliv") String isDeliv) throws ParseException {
		Selectors.wireComponents(view, this, false);
		oUser = (Muser) zkSession.getAttribute("oUser");
		this.isdlvcust = isDeliv;
			...
			public void render(Row row, final Tdelivery data, int index) throws Exception {
				...
				check.addEventListener(Events.ON_CHECK, new EventListener<Event>() {
					...
					public void onEvent(Event event) throws Exception {
						...
						BindUtils.postNotifyChange(null, null, CustdeliveryListVm.this, "totalselected");
						BindUtils.postNotifyChange(null, null, CustdeliveryListVm.this, "totaldataselected");
					}
				});
						...
						win.addEventListener(Events.ON_CLOSE, new EventListener<Event>() {
							...
							public void onEvent(Event event) throws Exception {
								...
								if (isSaved != null && isSaved) {
									...
									refreshModel(pageStartNumber);
									BindUtils.postNotifyChange(null, null, CustdeliveryListVm.this, "pageTotalSize");
								}
							}
						});
						win.doModal();
					...
					Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
						...
						public void onEvent(Event event) throws Exception {
							if (event.getName().equals("onOK")) {
								...
								mapData = new HashMap<>();
								refreshModel(pageStartNumber);
								BindUtils.postNotifyChange(null, null, CustdeliveryListVm.this, "*");
							}
						}
					});
		}
		...
		try {
			if (obj != null) {
				...
				filter = "tdelivery.productgroup = '" + productgroup + "' and Date(tdelivery.processtime) = '"
						...
						+ oUser.getMbranch().getBranchid() + "' and isdlvcust = " + isdlvcust;
